...
class RetourClient extends CommonObject
{
	...
	public $fields=array(
		...
		'statut' =>array('type'=>'enum(\'ouverte\',\'validée\',\'remboursée\')', 'label'=>'Statut', 'enabled'=>1, 'visible'=>-1, 'position'=>500),
		...
		'mode_remboursement' =>array('type'=>'enum(\'espèces\',\'CB\')', 'label'=>'Moderemboursement', 'enabled'=>1, 'visible'=>-1, 'position'=>50),
