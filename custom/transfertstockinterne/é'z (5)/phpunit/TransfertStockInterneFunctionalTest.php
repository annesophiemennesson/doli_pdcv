...
/**
 * \file    test/phpunit/TransfertStockInterneFunctionalTest.php
...
/**
 * Class TransfertStockInterneFunctionalTest
 *
 ...
 *
 * @package Testtransfertstockinterne
 */
class TransfertStockInterneFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTransfertStockInterne')->click();
		} else {
			// Disable the module
			$this->byHref('modTransfertStockInterne')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/transfertstockinterne/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('transfertstockinterne/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/transfertstockinterne/admin/about.php');
		$this->authenticate();
		return $this->assertContains('transfertstockinterne/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('transfertstockinternewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTransfertStockInterne_TransfertStockInterneTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTransfertStockInterne_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
