...
print '<a href="'.dol_buildpath('/custom/transfertstockinterne/list.php', 1).'">Liste des demandes de transfert</a><br/>';
...
print '<a href="'.dol_buildpath('/custom/transfertstockinterne/reception.php', 1).'">Transferts à réceptionner</a><br/>';
