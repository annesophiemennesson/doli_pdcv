...
llxHeader("", $langs->trans("InventaireArea"));

print load_fiche_titre($langs->trans("InventaireArea"), '', 'inventaire.png@inventaire');
...
// Draft MyObject
if (! empty($conf->inventaire->enabled) && $user->rights->inventaire->read)
{
	$langs->load("orders");
...
if (! empty($conf->inventaire->enabled) && $user->rights->inventaire->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."inventaire_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
