...
/**
 * \file    test/phpunit/TakeposLotsSerialsFunctionalTest.php
...
/**
 * Class TakeposLotsSerialsFunctionalTest
 *
 ...
 *
 * @package Testtakeposlotsserials
 */
class TakeposLotsSerialsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTakeposLotsSerials')->click();
		} else {
			// Disable the module
			$this->byHref('modTakeposLotsSerials')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/takeposlotsserials/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('takeposlotsserials/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/takeposlotsserials/admin/about.php');
		$this->authenticate();
		return $this->assertContains('takeposlotsserials/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('takeposlotsserialswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTakeposLotsSerials_TakeposLotsSerialsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTakeposLotsSerials_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
