...
/**
 *  \file       core/modules/gestionrebuts/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_demandeavoir
 */
class pdf_standard_demandeavoir extends ModelePDFDemandeAvoir
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_DEMANDEAVOIR_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->gestionrebuts->dir_output.'/demandeavoir') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->gestionrebuts->dir_output.'/demandeavoir';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->gestionrebuts->dir_output.'/demandeavoir/'.$objectref;
