...
/**
 * \file    test/phpunit/RetourClientFunctionalTest.php
...
/**
 * Class RetourClientFunctionalTest
 *
 ...
 *
 * @package Testretourclient
 */
class RetourClientFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modRetourClient')->click();
		} else {
			// Disable the module
			$this->byHref('modRetourClient')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/retourclient/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('retourclient/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/retourclient/admin/about.php');
		$this->authenticate();
		return $this->assertContains('retourclient/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('retourclientwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modRetourClient_RetourClientTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modRetourClient_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
