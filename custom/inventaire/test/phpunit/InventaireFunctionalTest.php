...
/**
 * \file    test/phpunit/InventaireFunctionalTest.php
 * \ingroup inventaire
...
/**
 * Class InventaireFunctionalTest
 *
 ...
 *
 * @package Testinventaire
 */
class InventaireFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInventaire')->click();
		} else {
			// Disable the module
			$this->byHref('modInventaire')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/inventaire/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('inventaire/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/inventaire/admin/about.php');
		$this->authenticate();
		return $this->assertContains('inventaire/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('inventairewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInventaire_InventaireTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInventaire_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
