...
/**
 * \file    test/phpunit/GestionRebutsFunctionalTest.php
...
/**
 * Class GestionRebutsFunctionalTest
 *
 ...
 *
 * @package Testgestionrebuts
 */
class GestionRebutsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGestionRebuts')->click();
		} else {
			// Disable the module
			$this->byHref('modGestionRebuts')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/gestionrebuts/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gestionrebuts/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gestionrebuts/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gestionrebuts/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gestionrebutswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGestionRebuts_GestionRebutsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGestionRebuts_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
